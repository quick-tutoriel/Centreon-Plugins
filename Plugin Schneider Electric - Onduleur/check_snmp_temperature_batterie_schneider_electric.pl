...
##
## OID permettant de récupérer la température de la batterie de l'onduleur
## upsAdvBatteryTemperature
##
my $snmp_oid_temperature = ".1.3.6.1.4.1.318.1.1.1.2.2.2.0";

##
## Permet de faire un get sur une feuille (OID)
##
my $resultOID = $session->get_request(-varbindlist => [$snmp_oid_temperature]);
...
##
my $result = $resultOID->{$snmp_oid_temperature};
...
##
$output = "Battery Temperature: $result C (Seuils W:$opt_w C:$opt_c)";
$perfdata = "Battery-Temperature=$result;$opt_w;$opt_c;0;100";	 
